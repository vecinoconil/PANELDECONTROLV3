...
cur.execute("""SELECT column_name FROM information_schema.columns
               WHERE table_name='articulos_codbarras' ORDER BY ordinal_position""")
print("articulos_codbarras cols:", [r["column_name"] for r in cur.fetchall()])
cur.execute("SELECT * FROM articulos_codbarras LIMIT 3")
